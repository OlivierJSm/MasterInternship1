...
from .hicgeneral import import_cool, get_chrs, standardize_coolers, standardize_coolers_ref, import_cool_dir, get_cool_name, standardize_coolers_bulk, fetch_region, bin_contact_map, bulk_coarsen
...
__all__ = ["calc_scc_file", "avg_scc", "avg_scc_weighted", "bulk_compare", "get_chrs", 
           ...
           "hic_ot_bulk_clr", "bulk_coarsen", "scc_bulk"]